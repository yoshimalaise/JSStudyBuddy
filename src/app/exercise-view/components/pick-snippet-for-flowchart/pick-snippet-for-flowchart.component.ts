...
@Component({
  selector: 'app-pick-snippet-for-flowchart',
  templateUrl: './pick-snippet-for-flowchart.component.html',
  styleUrls: ['./pick-snippet-for-flowchart.component.scss'],
})
export class PickSnippetForFlowchartComponent implements OnInit {
  @Input() exercise?: any;
